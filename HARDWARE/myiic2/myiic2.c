...
#define RCC_I2C_PORT 	RCC_APB1Periph_I2C1		/* GPIO端口时钟 */
...
/* 定义读写SCL和SDA的宏 */
#define I2C_SCL_1()  PORT_I2C_SCL->BSRRH = I2C_SCL_PIN				/* SCL = 1 */
#define I2C_SCL_0()  PORT_I2C_SCL->BSRRL = I2C_SCL_PIN				/* SCL = 0 */

#define I2C_SDA_1()  PORT_I2C_SDA->BSRRH = I2C_SDA_PIN				/* SDA = 1 */
#define I2C_SDA_0()  PORT_I2C_SDA->BSRRL = I2C_SDA_PIN				/* SDA = 0 */
...
void myiic_Init(void)
{
 ...
 GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;//* 开漏输出模式
	//GPIO_InitStructure.GPIO_Mode = GPIO_Out_OD;	/* 开漏输出模式 */
